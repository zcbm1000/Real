...
loginFail = 0
# loginFail 을 0으로 할당함(로그인 실패시 사용할거기에 현재횟수는 0으로 지정 실패시 추가1개씩 올리면됨)
...
#   member 라는 딕셔너리를 지정하고 딕셔너리 내부로 입력했던 
#   내용('ID', 'PW', 'EMAIL', 'PHONE')들을 할당함.
...
#   (시도횟수 나누기 3이아닌 '' 안에있기에 문자열 그대로 시도횟수 / 3이된다.) 
